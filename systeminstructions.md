...
Build a **personal finance dashboard** for tracking income, expenses, savings, and budget. The app allows users to monitor their financial health, view transaction history, manage cards, and track spending against budget limits. The data in this dashboard is stored locally in the browser and is not connected to any external services or databases. The data for the transactions will be fed by the n8n server.
